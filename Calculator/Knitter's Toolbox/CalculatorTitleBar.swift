//
//  CalculatorTitleBar.swift
//  Knitter's Toolbox
//
//  Created by Jonathan Herzog on 1/28/15.
...
class  CalculatorTitleBar: UILabel {
    ...
    func style() {
        self.layer.borderColor = CalculatorTitleBar.borderColor
        self.layer.borderWidth = CalculatorTitleBar.borderWidth
    }
